...
part of 'carton_price_breakdown_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CartonPriceBreakDownModel _$CartonPriceBreakDownFromJson(Map<String, dynamic> json) {
  return CartonPriceBreakDownModel(
...
Map<String, dynamic> _$CartonPriceBreakDownToJson(
    CartonPriceBreakDownModel instance) =>
    <String, dynamic>{
      'pk_cpbd': instance.id,
