...
part of 'unit_price_breakdown_model.dart';

UnitPriceBreakDownModel _$UnitPriceBreakDownFromJson(Map<String, dynamic> json) {
...
Map<String, dynamic> _$UnitPriceBreakDownToJson(UnitPriceBreakDownModel instance) =>
    <String, dynamic>{
      'pk_upbd': instance.id,
